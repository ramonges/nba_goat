...
const CATEGORY_INFO = {
  "Scoring Production": { summary: "Measures overall offensive output per season", metrics: ["Points per game", "Game Score mean"], direction: "Higher is better" },
  ...
  "Total Rebounding": { summary: "Overall rebounding ability", metrics: ["Rebounds per game"], direction: "Higher is better" },
  "Offensive Rebounding": { summary: "Offensive boards", metrics: ["Off. rebounds per game"], direction: "Higher is better" },
  "Defensive Rebounding": { summary: "Defensive boards", metrics: ["Def. rebounds per game"], direction: "Higher is better" },
  Assists: { summary: "Playmaking and ball distribution", metrics: ["Assists per game", "AST/TOV ratio"], direction: "Higher is better" },
  Steals: { summary: "Ball-hawking on defense", metrics: ["Steals per game"], direction: "Higher is better" },
  Blocks: { summary: "Shot-blocking ability", metrics: ["Blocks per game"], direction: "Higher is better" },
  "Foul Discipline": { summary: "Defending without fouling", metrics: ["Fouls per game"], direction: "Lower is better (fewer fouls)" },
  "True Shooting Efficiency": { summary: "Overall shooting efficiency (TS%; ≥ 200 games in decade)", metrics: ["TS% = PTS / (2 × (FGA + 0.44 × FTA))"], direction: "Higher is better" },
  "Field Goal Efficiency": { summary: "Shooting accuracy from the field (eFG%; ≥ 200 games in decade)", metrics: ["eFG% = (FGM + 0.5×3PM) / FGA"], direction: "Higher is better" },
  ...
  "Turnover Control": { summary: "Taking care of the ball", metrics: ["Turnovers per game"], direction: "Lower is better (fewer TOs)" },
  ...
  "Win Percentage Regular Season": { summary: "Regular-season win percentage (≥ 41 games)", metrics: ["win_percentage"], direction: "Higher is better" },
  "Plus-Minus Impact": { summary: "Net scoring margin when on court", metrics: ["+/- per game"], direction: "Higher is better" },
  ...
  "Playoff Buzzer shot made": { summary: "Playoff game-winning buzzer makes", metrics: ["Count of playoff_buzzer_make = 1"], direction: "Higher is better" },
